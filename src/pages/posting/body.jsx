...
import { getFamilyInfo, posting } from "../../apis/postingApi/apis";
function Body() {
    ...
    const handleOnSubmit = (e) => {
        ...
        if(!title){
            ...
            posting(navigate, familyCode, familyId, memberId, title, content, photo);
        }
    }
    ...
    return (
        <PostBody>
            <form onSubmit={handleOnSubmit}>
                ...
                <button type="submit" id="completeBtn">작성완료</button>
            </form>
        </PostBody>
    )
}
